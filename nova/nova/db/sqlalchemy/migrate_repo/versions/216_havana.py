...
def _populate_instance_types(instance_types_table):
    default_inst_types = {
        'm1.tiny': dict(mem=512, vcpus=1, root_gb=1, eph_gb=0, flavid=1, bandwidth=100),
        'm1.small': dict(mem=2048, vcpus=1, root_gb=20, eph_gb=0, flavid=2, bandwidth=200),
        'm1.medium': dict(mem=4096, vcpus=2, root_gb=40, eph_gb=0, flavid=3, bandwidth=400),
        'm1.large': dict(mem=8192, vcpus=4, root_gb=80, eph_gb=0, flavid=4, bandwidth=600),
        'm1.xlarge': dict(mem=16384, vcpus=8, root_gb=160, eph_gb=0, flavid=5, bandwidth=800)
        }
    ...
    try:
        ...
        for name, values in default_inst_types.iteritems():
            i.execute({'name': name, 'memory_mb': values["mem"],
                        ...
                        'disabled': False,
                        'is_public': True,
                        'network_bandwidth': values["bandwidth"]})
    except Exception:
