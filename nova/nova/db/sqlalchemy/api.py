...
def model_query(context, model, *args, **kwargs):
    ...
    use_subordinate = _default('use_subordinate', lambda: False)

    # Can't use a subordinate if it's not specified
    if CONF.database.subordinate_connection == '':
        use_subordinate = False

    session = _default('session', lambda: get_session(use_subordinate=use_subordinate))
