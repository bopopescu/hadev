...
class FilterScheduler(driver.Scheduler):
    ...
    def _schedule(self, context, request_spec, filter_properties):
        ...
        #if instance_properties.get('network_bandwidth') == None:
        instance_properties['network_bandwidth'] = instance_type['network_bandwidth'];
        #    request_spec['instance_type']['network_bandwidth'] = 100;
