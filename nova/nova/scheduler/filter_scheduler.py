...
class FilterScheduler(driver.Scheduler):
    ...
    def select_instance_destinations(self, context, app, filter_properties):
        ...
        selected_instances = self._schedule_instance(context, app, filter_properties)

        # Couldn't fulfill the request_spec

        instance = selected_instances.instance;
    ...
    def _schedule_instance(self, context, app, filter_properties):
