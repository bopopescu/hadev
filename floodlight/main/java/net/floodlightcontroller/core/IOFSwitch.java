...
public interface IOFSwitch {
    ...
    /**
     * Returns a Future object that can be used to retrieve the asynchronous
     * OFQueueGetConfigReply when it is available.
     *
     * @param request queue config request
     * @return Future object wrapping OFQueueGetConfigReply
     * @throws IOException
     */
    public Future<List<OFPacketQueue>> queueGetConfig(OFQueueGetConfigRequest request)
    ...
    /**
     * Deliver the queue get config future reply
     * @param reply the reply to deliver
     */
    ...
    /**
     * Cancel the queue config reply with the given transaction ID
     * @param transactionId the transaction ID
     */
