...
public class HostResource extends org.restlet.resource.ServerResource {
    ...
    protected void jsonToHostDefinition(String json, HostDefinition host) throws IOException {
        ...
        System.out.println(" json to host ");
        jp.nextToken();
        ...
        while (jp.nextToken() != JsonToken.END_OBJECT) {
            ...
            if (jp.getText().equals("")) 
                ...
                System.out.println(" entering attachment ");
                while (jp.nextToken() != JsonToken.END_OBJECT) {
                    ...
                    if (field.equals("id")) {
                        ...
                        host.mac = jp.getText();
                        System.out.println(" found mac " + jp.getText());
                    }
                }
            }
        }
    ...
    public String addHost(String postData) {
        ...
        host.mac = (String) getRequestAttributes().get("mac_address");
        System.out.println(" host port is " + host.port);
        System.out.println(" host guid is " + host.guid);
        ...
        System.out.println(" host mac is " + host.mac);
