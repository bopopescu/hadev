...
def createTopo(  ):
    ...
    info( '*** adding q h1-h2\n' )
    cmd1 = 'curl -i http://221.199.216.240:8080/wm/haqos/addqueues/00:00:00:00:00:00:00:05/s5-eth1/00:00:00:00:00:00:00:06/s6-eth2/40000000/5001/10.0.0.1/json -X PUT';
    result1 = os.popen(cmd1);
    time.sleep(3);
    info( '*** adding q h2-h1\n' )
    cmd2 = 'curl -i http://221.199.216.240:8080/wm/haqos/addqueues/00:00:00:00:00:00:00:06/s6-eth2/00:00:00:00:00:00:00:05/s5-eth1/40000000/-1/10.0.0.3/json -X PUT';

    result2 = os.popen(cmd2);


    #info( '*** adding q h1-h2\n' )
    cmd1 = 'curl -i http://221.199.216.240:8080/wm/haqos/addqueues/00:00:00:00:00:00:00:05/s5-eth2/00:00:00:00:00:00:00:06/s6-eth3/60000000/5001/10.0.0.2/json -X PUT';
    result1 = os.popen(cmd1);
    time.sleep(3);
    info( '*** adding q h2-h1\n' )
    cmd2 = 'curl -i http://221.199.216.240:8080/wm/haqos/addqueues/00:00:00:00:00:00:00:06/s6-eth3/00:00:00:00:00:00:00:05/s5-eth2/60000000/-1/10.0.0.4/json -X PUT';
